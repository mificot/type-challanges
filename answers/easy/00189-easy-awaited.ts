...
type Thenable<T> = { then: (onfulfilled: (result: T) => any) => any }

type MyAwaited<T extends Thenable<any>> = T extends Thenable<infer Result> ?
  Result extends Thenable<any> ? MyAwaited<Result> : Result : never
